...
cd /root && wget -qO Fuck_OCPU.sh https://raw.githubusercontent.com/xingyu2016/Oracle_OneKey_Active/main/Fuck_OCPU.sh && chmod +X Fuck_OCPU.sh && bash Fuck_OCPU.sh ${Cores}
